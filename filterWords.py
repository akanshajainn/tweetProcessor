class filterWords:
    ...
    STOP_WORDS = ["a","amp","as","able","about","above",
                  "according","accordingly","across",
                  ...
                  "awfully","be","became","because","become",
                  "becomes","becoming","been","before","beforehand",
                  "behind","being","believe","below","beside",
                  "besides","best","better","between","beyond",
                  "both","brief","but","by","c'mon","c's","came",
                  "can","can't","cannot","cant","cause","causes",
                  ...
                  "gets","getting","given","gives","go","goes",
                  "going","gone","got","gotten","greetings","had",
                  ...
                  "now","nowhere","obviously","of","off","often",
                  "oh","ok","okay","old","on","once","one","ones",
                  ...
                  "presumably","probably","provides","que","quite","qv",
                  ...
                  "specifying","still","sub","such","sup","sure","t's","take",
                  ...
                  "try","trying","twice","two","un","under","unfortunately",
